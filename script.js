...
async function optionalFetch(url, options = {}) {
    try {
        ...
        console.warn(
            'Optional Roblox request failed:',
            url,
            error
        );
...
async function performSearch() {
    ...
    try {
        ...
        try {
            ...
            throw new Error(
                'Roblox search is temporarily unavailable. Please try again.'
            );
        }
        ...
        if (successfulRequests < 3) {
            ...
            showError(
                'The profile was found, but some information could not be loaded.',
                true
            );
        }
